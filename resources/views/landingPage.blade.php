...
<head>
    ...
    <title>Solvesio Web Agency</title>
...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <h4>Solvesio <img src="{{ asset('landingPage/assets/images/logo-icon.png') }}"
                                    alt=""></h4>
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                                <img src="{{ asset('landingPage/assets/images/banner-right-image.png') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
    ...
    <div id="about" class="about-us section" style="margin-bottom: 60px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
    ...
    <div id="team" class="our-portfolio team-bg section">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="section-heading wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                        <h6>Meet Our Team</h6>
                        <h2>Get to Know Our <span>Team</span> And <span>Experts</span></h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="loop owl-carousel">
                        ...
                        <div class="item">
                            ...
                            {{-- <div class="portfolio-item">
                                <div class="thumb">
                                    <img src="{{ asset('landingPage/assets/images/portfolio-05.jpg') }}"
                                        alt="">
                                    <div class="hover-content">
                                        <div class="inner-content">
                                            <a href="#">
                        ...
                        <div class="item">
                            ...
                            {{-- <div class="portfolio-item">
                                <div class="thumb">
                                    <img src="{{ asset('landingPage/assets/images/portfolio-06.jpg') }}"
                                        alt="">
                                    <div class="hover-content">
                                        <div class="inner-content">
                                            <a href="#">
                ...
                <div class="col-lg-4">
                    <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="icon">
                                    <img src="{{ asset('landingPage/assets/images/service-icon-01.png') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                ...
                <div class="col-lg-4">
                    <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="icon">
                                    <img src="{{ asset('landingPage/assets/images/service-icon-02.png') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                ...
                <div class="col-lg-4">
                    <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="icon">
                                    <img src="{{ asset('landingPage/assets/images/service-icon-03.png') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-lg-8">
                            ...
                            <div class="col-lg-3">
                                <div class="contact-info">
                                    <ul>
                                        <li>
                                            <div class="icon">
                                                <img src="{{ asset('landingPage/assets/images/contact-icon-01.png') }}"
                                                    alt="email icon">
                                            </div>
                                        ...
                                        <li>
                                            <div class="icon">
                                                <img src="{{ asset('landingPage/assets/images/contact-icon-02.png') }}"
                                                    alt="phone">
                                            </div>
                                        ...
                                        <li>
                                            <div class="icon">
                                                <img src="{{ asset('landingPage/assets/images/contact-icon-03.png') }}"
                                                    alt="location">
                                            </div>
